...
!(function(u,$){
    ...
    function load(callBack) {
        parser = null;
        $.get(this.publicPath+'/grammar/pegs/'+this.type+'.pegjs',null,res => {
            parser = PEG.generate(res);
        })
    }
